...
def app():
    ...
    if st.session_state.username != '':
        ...
        st.title(":orange[Fish Farming Expert Chatbot]")
        st.write(":orange[Welcome to your personal fish farming expert chatbot app! Ask any question related to fish farming:]")
        ...
        def generate_response(user_input, chat_history=None):
            ...
            response = openai.chat.completions.create(
                model="ft:gpt-3.5-turbo-0613:personal::8nlWrN14",
                messages=messages
            )
